...
if st.session_state.probs is not None:
    ...
    st.markdown("---")
    st.markdown("## 📊 Simulated Regional Brackets")
    ...
    st.info(
    "These predictions are generated by a statistical model and should be interpreted as probabilities, not guarantees. "
    "Because the model is trained on historical team data, it may reflect limitations or biases in the data, including "
    "overvaluing teams from historically stronger or more data-rich conferences."
    )